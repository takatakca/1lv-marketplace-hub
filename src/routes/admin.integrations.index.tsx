...
function Page() {
  ...
  return (
    <>
      <div className="mb-4">
        <Link
          to="/admin/integrations/takatak"
          className="inline-flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm font-semibold text-navy hover:bg-muted"
        >
          Open TAKATAK Master Sync console →
        </Link>
      </div>
